...
export interface Player {
  ...
  // Ranked : exposé directement par l'API officielle (confirmé le 20/08/2026
  // par un appel réel — absent des docs tierces qu'on avait consultées avant
  // ça, visiblement pas à jour). Absent tant que le joueur n'a jamais joué
  // Ranked, d'où l'optionnalité.
